# OpenMythos - Research Roadmap

**Status:** Active research. Not yet in production.

OpenMythos is Entity's path toward specialized cognitive sovereignty
...
OpenMythos fine-tunes small open-weight base models with LoRA adapters
...
Internal codename. Reference to threat tier classification used in early
Entity design discussions. The project name is internal; public references
should use "Entity Adapters" or "OpenMythos research".
...
*Sovereignty is incremental. OpenMythos is one path. Mesh-LLM is another.*
